...
@section('title', $competition->name . ' — Buganda Tourism Board')
                ...
                <div class="p-6">
                    ...
                    <div class="mt-6 pt-4 border-t border-gray-100">
                        ...
                        <div class="flex justify-center gap-3">
                            <a :href="'https://wa.me/?text=Vote for ' + selectedContestant.full_name + ' on Buganda Tourism Board! ' + window.location.href" target="_blank"
                            ...
                            <a :href="'https://twitter.com/intent/tweet?text=Vote for ' + selectedContestant.full_name + ' on Buganda Tourism Board!&url=' + window.location.href" target="_blank"
