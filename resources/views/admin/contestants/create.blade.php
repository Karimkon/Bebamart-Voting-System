        ...
        <div class="bg-white rounded-xl border border-gray-100 p-6">
            ...
            <div class="space-y-4">
                ...
                <div>
                    ...
                    <select name="parish_id" id="parish_select" class="w-full px-4 py-2.5 border border-gray-200 text-sm focus:outline-none focus:border-[#d4941a] bg-white">
                    ...
                    @if($regions->isEmpty())
                        <p class="text-xs text-amber-600 mt-1">No regions/parishes yet. <a href="#" class="underline">Create them first</a> or leave blank.</p>
                    @endif
                </div>
